...
from db.mysql_relevant.sql_str.sql_str import SELECT_SYSTEM_INFO, QUERY_SYS_INFO
from db.mysql_relevant.sql_str.system_info import DELETE_SYSTEM_INFO, INSERT_SYSTEM_INFO, UPDATE_SYSTEM_INFO, \
    SELECT_BASE_SYSTEM_INFO
