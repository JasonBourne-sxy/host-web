...
from db.mysql_relevant.sql_str.monitor_instance import DELETE_MONITOR_INSTANCE, UPDATE_MONITOR_INSTANCE
from db.mysql_relevant.sql_str.sql_str import QUERY_MONITOR_INSTANCE, INSERT_MONITOR_INSTANCE
...
class MonitorInstancesService:
    ...
    def __insert_monitor_instance(json_obj):
        ...
        sql = INSERT_MONITOR_INSTANCE % (get_uuid_str(),
                                         ...
                                         TypeChange.to_string(json_obj, 'port'),
    ...
    def insert_or_update_monitor_instance(json_obj):
        ...
        :return:
        """
        sys_id = json_obj['sys_id']
        sys_name = SystemInfoService.get_system_name_by_id(sys_id)
        json_obj['sys_name'] = sys_name
...
def main():
    result = MonitorInstancesService.query_instance_by_condition(sys_id='6bd97c1ec2c0443ca937588fe601d53f',
                                                                 sys_name=None,
